...
export const oldForestRoad = location({ name: "Old Forest Road", threat: 1, questPoints: 3, traits: ["forest"] });

export const forestGate = location({ name: "Forest Gate", threat: 2, questPoints: 4, traits: ["forest"] });
...
export const enchantedStream = location({ name: "Enchanted Stream", threat: 2, questPoints: 2, traits: ["forest"] });
