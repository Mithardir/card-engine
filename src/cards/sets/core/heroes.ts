...
export const gimli: Card = (self) => {
  return hero(
    ...
    //   modifier: bindModifier(get("damage")(self), increment("attack")),
    // })
  );
};

export const legolas: Card = (self) => {
  return hero(
    {
      name: "Legolas",
      threatCost: 9,
...
export const glorfindel: Card = (self) => {
  return hero(
    {
      name: "Glorfindel",
      threatCost: 12,
